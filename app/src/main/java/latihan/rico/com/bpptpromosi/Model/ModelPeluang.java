...
public class ModelPeluang implements Parcelable {
    private String id;
...
// Getter Methods
    ...
    protected ModelPeluang(Parcel in) {
        id = in.readString();
        ...
        status_kepemilikan = in.readString();
        estimasi_biaya = in.readString();
    ...
    public static final Creator<ModelPeluang> CREATOR = new Creator<ModelPeluang>() {
        @Override
        public ModelPeluang createFromParcel(Parcel in) {
            return new ModelPeluang(in);
        }

        @Override
        public ModelPeluang[] newArray(int size) {
            return new ModelPeluang[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(status_kepemilikan);
        dest.writeString(estimasi_biaya);
